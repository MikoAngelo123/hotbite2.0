...
<img src="{{ asset('images/ayam.png') }}" class="food-img">
...
<img src="{{ asset('images/mie.png') }}" class="food-img">
...
function cariMenu(event){
    ...
    if(event.key === "Enter"){
        ...
        document.getElementById("produkUser").style.display = "none";
        ...
        if(keyword == ""){
            ...
            document.getElementById("produkUser").style.display = "block";
        }
